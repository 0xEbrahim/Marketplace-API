...
const yourProfile = asyncHandler(async (req, res, _next) => {
    const { _id } = req.user
    validateMongoID(_id)
...
const getSingleUsers = asyncHandler(async (req, res, _next)=>{
    const { id } = req.params
    validateMongoID(id)
...
const updateUsers = asyncHandler(async (req, res, _next)=>{
    const { _id } = req.user
    validateMongoID(_id)
    const pic = req.file
...
const deleteUsers = asyncHandler(async (req, res, _next)=>{
        const { id } = req.params
        validateMongoID(id)
...
const verifyAccount = asyncHandler(async (req, res, _next) => {
...
const finalVerify = asyncHandler(async (req, res, _next) => {
...
const userAds = asyncHandler(async (req, res, _next) => {
    const { _id } = req.user
    validateMongoID(_id)
...
// user favourite 
const addToFav = asyncHandler(async (req, res, _next) => {
    const { _id } = req.user
    const { id } = req.params
    validateMongoID(_id)
    validateMongoID(id)
